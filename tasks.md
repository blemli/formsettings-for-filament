...
maybe instead of the reorder list we show interactive badges on the form fields (hide, entry point) and let the user draw a line from one to the next field which gives the order? would be very intuitive no?![SCR-20260731-qoqi](assets/SCR-20260731-qoqi.png)
